...
def iterative_solution(line, result, current_value):
    ...
    return iterative_solution(line[1:], result, current_value+line[0]) or iterative_solution(line[1:], result, current_value*line[0])
...
print(answer)
submit(answer, part="a", day=7, year=2024, session=session_id)