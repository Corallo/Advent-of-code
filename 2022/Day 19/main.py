...
def solve(blueprint):
    ...
    # Objective: maximize the amount of geode[t] at time t=24
    objective = geode[t]
...
print(sum([solve(blueprint_list[i])*(i+1) for i in range(len(blueprint_list))]))
